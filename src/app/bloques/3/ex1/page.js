...
const titleStyle = { color: '#FFD700', fontSize: '1.5rem', fontWeight: 900, marginBottom: '15px', fontFamily: 'Montserrat, sans-serif' };
const bodyStyle = { color: '#ddd', fontSize: '1.05rem', lineHeight: 1.7, marginBottom: '25px', fontFamily: 'Montserrat, sans-serif' };
const btnStyle = {
    background: '#FFD700', color: '#000', border: 'none', padding: '12px 28px',
...
export default function Exercise1Block3() {
